...
All `src/*` compiled: GPIO, UART PL011, SPI PL022, I2C DW_apb_i2c, Timer 64-bit, PWM 12 slices (RP2350) / 8 (RP2040), ADC 9-mux, DMA 16ch, PIO 2 blocks, NVIC + SAU/MPU, HSTX/TMDS, TRNG, SHA-256, Clocks, USB, RTC, ROM, SIO, VREG, M33 DSP/MVE + VFP/DCP, RV32 Zfinx float, etc., SD/eMMC SPI, W5500, BME280, CYW43 TAP, VNet, SDD, all verified via `425` tests and firmware UART.
